   ...
   @section('content')
       ...
       <div class="bg-info p-3">
           ...
           <form action="{{ route('admin.candidate.update', $user['id']) }}" method="post" enctype="multipart/form-data">
               ...
               <div class="row">
                   ...
                   <div class="col-12 col-md-6 py-1">
                       <div class="row">
                           ...
                           <div class="col-7"> <input class="form-control" type="text"
                                   value="{{ $user['present_address'] }}" name="present_address" /></div>
                       </div>
                   </div>
                   <div class="col-12 col-md-6 py-1">
                       <div class="row">
                   ...
                   <div class="col-12 col-md-6 py-1">
                       <div class="row">
                           ...
                           <div class="col-7"> <input class="form-control" type="text"
                                   value="{{ $user['father_phone'] }}" name="father_phone" /></div>
                       </div>
                   </div>
                   ...
                   <div class="col-12 col-md-6 py-1">
                       <div class="row">
                           ...
                           <div class="col-7"> <input class="form-control" type="text"
                                   value="{{ $user['mother_phone'] }}" name="mother_phone" /></div>
                       </div>
                   </div>
                   ...
                   <div class="col-12 col-md-6 py-1">
                       <div class="row">
                           ...
                           <div class="col-7"> <input class="form-control" type="text"
                                   value="{{ $user['extra_virtue'] }}" name="extra_virtue" /></div>
                       </div>
                   </div>
