    ...
    <div class="bg-info px-5 pb-3">
        ...
        <div class="row mb-3">
            ...
            <div class="col-6 text-right">
                <a href="{{ route('admin.candidate.edit', $user['id']) }}" class="btn btn-warning">Edit</a>
                <a target="_blank" href="{{ route('admin.print.candidate', $user['id']) }}" class="btn btn-dark">Print</a>
            </div>
        ...
        <div class="row my-2">
            <div class="col-6 pt-2"><a href="{{ route('admin.candidate.show', $user['id'] - 1) }}"
                    class="btn btn-dark">Previous</a></div>
            <div class="col-6 text-right pt-2"><a href="{{ route('admin.candidate.show', $user['id'] + 1) }}"
                    class="btn btn-light">Next</a></div>
        </div>
